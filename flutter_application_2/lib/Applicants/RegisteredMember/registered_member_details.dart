...
import 'package:flutter_application_2/Applicants/RegisteredMember/registered_member_profile.dart';
import 'package:flutter_application_2/app_colors.dart';

class RegisteredMemDetails extends StatefulWidget {
  const RegisteredMemDetails({Key? key}) : super(key: key);

  @override
  _RegisteredMemDetailsState createState() => _RegisteredMemDetailsState();
}

class _RegisteredMemDetailsState extends State<RegisteredMemDetails> {
  @override
      ...
      children: [
        ...
        Container(
          ...
          child: TextButton.icon(
            ...
            label: Text('search for registered members'),
            onPressed: () {},
            style: ButtonStyle(
              backgroundColor:
            ...
            GestureDetector(
                ...
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => RegisteredMemProfile()));
                }),
          ],
        ),
      ),

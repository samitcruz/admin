...
import 'package:flutter_application_2/Applicants/AppliedMember/applied_member_profile.dart';
import 'package:flutter_application_2/app_colors.dart';

class AppliedMemDetails extends StatefulWidget {
  const AppliedMemDetails({Key? key}) : super(key: key);

  @override
  _AppliedMemDetailsState createState() => _AppliedMemDetailsState();
}

class _AppliedMemDetailsState extends State<AppliedMemDetails> {
  @override
      ...
      children: [
        ...
        Container(
          ...
          child: TextButton.icon(
            ...
            label: Text('search for applied members'),
            onPressed: () {},
            style: ButtonStyle(
              backgroundColor:
            ...
            GestureDetector(
                ...
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => AppliedMemProfile()));
                }),
          ],
        ),
      ),

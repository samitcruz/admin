...
import 'package:flutter_application_2/MemberManagement/ModernDancers/modern_dancer_profile.dart';
import 'package:flutter_application_2/app_colors.dart';

class ModernDancerDetails extends StatefulWidget {
  const ModernDancerDetails({Key? key}) : super(key: key);

  @override
  _ModernDancerDetailsState createState() => _ModernDancerDetailsState();
}

class _ModernDancerDetailsState extends State<ModernDancerDetails> {
  @override
      ...
      children: [
        ...
        Container(
          ...
          child: TextButton.icon(
            ...
            label: Text('search for modern dancers'),
            onPressed: () {},
            style: ButtonStyle(
              backgroundColor:
            ...
            GestureDetector(
                ...
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ModernDancerProfile()));
                }),
          ],
        ),
      ),

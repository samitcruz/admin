...
import 'package:flutter_application_2/MemberManagement/ModernChereographer/modern_chereographer_profile.dart';
import 'package:flutter_application_2/app_colors.dart';

class ModernChereographerDetails extends StatefulWidget {
  const ModernChereographerDetails({Key? key}) : super(key: key);

  @override
  _ModernChereographerDetailsState createState() =>
      _ModernChereographerDetailsState();
}

class _ModernChereographerDetailsState
    extends State<ModernChereographerDetails> {
  @override
      ...
      children: [
        ...
        Container(
          ...
          child: TextButton.icon(
            ...
            label: Text('search for modern chereographer'),
            onPressed: () {},
            style: ButtonStyle(
              backgroundColor:
            ...
            GestureDetector(
                ...
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => ModernChereographerProfile()));
                }),
          ],
        ),
      ),

...
import 'package:flutter_application_2/MemberManagement/HonoraryMember/honoraryMem_registeration.dart';
import 'package:flutter_application_2/MemberManagement/HonoraryMember/honorary_member_profile.dart';

import 'package:flutter_application_2/app_colors.dart';

class HonoraryMemberDetails extends StatefulWidget {
  const HonoraryMemberDetails({Key? key}) : super(key: key);

  @override
  _HonoraryMemberDetailsState createState() => _HonoraryMemberDetailsState();
}

class _HonoraryMemberDetailsState extends State<HonoraryMemberDetails> {
  @override
      ...
      children: [
        ...
        Container(
          ...
          child: TextButton.icon(
            ...
            label: Text('search for honorary members'),
            onPressed: () {},
            style: ButtonStyle(
              backgroundColor:
              ...
              child: TextButton(
                onPressed: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => HonoraryMemRegisteration()));
                },
                child: Text(
                  "Register",
                  style: TextStyle(
            ...
            GestureDetector(
                ...
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => HonoraryMemProfile()));
                }),
          ],
        ),
      ),

...
import 'package:flutter_application_2/MemberManagement/TraditionalChereographer/traditional_chereographer_profile.dart';
import 'package:flutter_application_2/app_colors.dart';

class TraditionalChereographerDetails extends StatefulWidget {
  const TraditionalChereographerDetails({Key? key}) : super(key: key);

  @override
  _TraditionalChereographerDetailsState createState() =>
      _TraditionalChereographerDetailsState();
}

class _TraditionalChereographerDetailsState
    extends State<TraditionalChereographerDetails> {
  @override
      ...
      children: [
        ...
        Container(
          ...
          child: TextButton.icon(
            ...
            label: Text('search for traditional chereographer'),
            onPressed: () {},
            style: ButtonStyle(
              backgroundColor:
            ...
            GestureDetector(
                ...
                onTap: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              TraditionalChereographerProfile()));
                }),
          ],
        ),
      ),

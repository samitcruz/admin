...
import 'package:flutter_application_2/MemberManagement/TraditionalChereographer/traditional_chereographer.dart';
...
class TraditionalChereographerProfile extends StatefulWidget {
  TraditionalChereographerProfile({Key? key}) : super(key: key);
...
//   );
  ...
  @override
  _TraditionalChereographerProfileState createState() =>
      _TraditionalChereographerProfileState();
}

class _TraditionalChereographerProfileState
    extends State<TraditionalChereographerProfile> {
      ...
      body: SafeArea(
        child: Row(
          ...
          children: [
            ...
            Expanded(
              flex: 5,
              child: TraditionalChereographer(),
            ),
